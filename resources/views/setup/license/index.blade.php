...
@section('content')
    <div class="p-6 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">License Type Management</h1>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 w-[100px] text-xs">
                                @php
                                    ...
                                    $status = $statuses[$licenseType->is_active] ?? [
                            ...
                            <td class="px-4 py-3 w-[50px]">
                                <div class="flex items-center justify-center space-x-2">
                                    <button type="button" title="Edit license type {{ $licenseType->name }}"
                                        data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        data-id="{{ $licenseType->id }}" data-name="{{ $licenseType->name }}"
                                        data-description="{{ $licenseType->description }}"
                                        data-status="{{ $licenseType->is_active }}" onclick="openEditModal(this)"
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-1">
                            <div class="w-full md:col-span-2">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="e.g. Firearms license" required>
                            </div>
                            <div class="sm:col-span-2">
                                ...
                                <textarea type="text" name="description" id="description" rows="3"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    placeholder="License type description"></textarea>
                            </div>
