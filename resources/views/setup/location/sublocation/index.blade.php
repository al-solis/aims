                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 w-[50px]">
                                <div class="flex items-center justify-center space-x-2">
                                    <button type="button" title="Edit sub-location {{ $sublocation->name }}"
                                        data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        data-id="{{ $sublocation->id }}" data-name="{{ $sublocation->name }}"
                                        data-code="{{ $sublocation->code }}"
                                        data-description="{{ $sublocation->description }}"
                                        data-status="{{ $sublocation->status }}" onclick="openEditModal(this)"
