...
@section('content')
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Manage supplies suppliers, view statistics, and maintain supplier information.
                </p>
            </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 w-[100px] text-xs font-semibold">
                                @php
                                    ...
                                    $status = $statuses[$supplier->is_active] ?? [
                            ...
                            <td class="px-4 py-3 w-[50px]">
                                <div class="flex items-center justify-center space-x-2">
                                    <button type="button" title="Edit Supplier {{ $supplier->name }}"
                                        ...
                                        data-status="{{ $supplier->is_active }}" onclick="openEditModal(this)"
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-1">
                                <label for="contact_number"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Telephone</label>
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-1">
                                <label for="edit_contact_number"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Telephone</label>
                                <input type="tel" name="edit_contact_number" id="edit_contact_number"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    placeholder="e.g. 09123456789">
                            </div>
                            ...
                            <div class="sm:col-span-1">
                                <label for="edit_contact_email"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Email</label>
                                <input type="email" name="edit_contact_email" id="edit_contact_email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    placeholder="e.g. juandelacruz@yahoo.com">
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                <label for="edit_address"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Address</label>
                                <textarea type="text" name="edit_address" id="edit_address" rows="3"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    placeholder="Supplier address"></textarea>
                            </div>
    ...
    <script>
        ...
        function openEditModal(button) {
            ...
            document.getElementById('edit_contact_number').value = button.getAttribute('data-contact_number');
            document.getElementById('edit_contact_email').value = button.getAttribute('data-email');
