        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Manage system users, view statistics, and maintain user information.
                </p>
            </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 w-[100px] text-xs font-semibold">
                                @php
                                    ...
                                    $status = $statuses[$user->is_active] ?? [
                ...
                <div class="overflow-y-auto max-h-[70vh]">
                    <form action="{{ route('user.store') }}" method="POST">
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                <label for="fname"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Given Name*</label>
                            ...
                            <div class="sm:col-span-2">
                                <label for="mname"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Middle Name</label>
                            ...
                            <div class="sm:col-span-1">
                                <label for="password"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Password</label>
                            ...
                            <div class="sm:col-span-1">
                                <label for="password_confirmation"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Confirm
                                    Password</label>
